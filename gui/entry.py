...
class Entry:
    def __init__(self, rest_image, hover_image,
        ...
        self.hover_image = gui.Image(hover_image, x, y)
        self.rest_focused_image = gui.Image(rest_focused_image, x, y)
        self.hover_focused_image = gui.Image(hover_focused_image, x, y)
